...
function mostrarAlerta(mensaje){
    ...
    if(!alerta){
        ...
        `;
        formualario.appendChild(alerta);
        setTimeout(()=>{
            alerta.remove();
        }, 3000);
    }
            ...
            <div class="w-1/2 md:w-1/3 lg:w-1/4 mb-4 p-3">
                <div class="bg-white ">
                    ...
                    <div class="p-4">
                        ...
                        target="_blank" class="bg-blue-800 w-full p-1 block mt-5 rounded text-center font-bold uppercase hover:bg-blue-500 text-blue">Ver Imagen</a>
                    </div>
                </div>
            </div>
            `;
